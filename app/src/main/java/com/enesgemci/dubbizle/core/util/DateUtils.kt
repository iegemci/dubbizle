...
object DateUtils {
    ...
    fun getChangedDate(day: Int): String {
        ...
        return calendar.get(Calendar.DAY_OF_MONTH).toString() + "." + (calendar.get(Calendar.MONTH) + 1) + "." + calendar.get(
            Calendar.YEAR
        )
    }
    ...
    fun isInPeriod(period: Int, startDate: String, endDate: String): Boolean {
        ...
        try {
            ...
            val requiredEndDate =
                startDateCal.get(Calendar.DAY_OF_MONTH).toString() + "." + (startDateCal.get(Calendar.MONTH) + 1) + "." + startDateCal.get(
                    Calendar.YEAR
                )
